...
Status = RunCommand(L"fs0:EmptyApplication.efi");
ASSERT_EFI_ERROR(Status);
//gBS->Stall(5000);
  ...
  )
{
  ...
  ShellInfoObject.ShellInitSettings.BitUnion.Bits.NoStartup    = TRUE;  //MaxDBG
  ...
  ShellInfoObject.ShellInitSettings.BitUnion.Bits.NoMap        = TRUE;  //MaxDBG
  ...
  ShellInfoObject.ShellInitSettings.Delay = 0;  //MaxDBG
